...
public class Constants {
  ...
  public static final double LATITUDE_NORTH = 90;
  public static final double LATITUDE_SOUTH = -90;
  public static final double LONGITUDE_EAST = 180;
  public static final double LONGITUDE_WEST = -180;
